...
final class Version20220412082939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, hotel_id INT NOT NULL, name VARCHAR(50) NOT NULL, shortdescription VARCHAR(100) DEFAULT NULL, description LONGTEXT DEFAULT NULL, pictures VARCHAR(255) DEFAULT NULL, capacity INT NOT NULL, size INT, bed INT NOT NULL, price INT NOT NULL, quantity_rooms INT NOT NULL, breaksfast VARCHAR(50), header_room VARCHAR(255) DEFAULT NULL, INDEX IDX_729F519B3243BB18 (hotel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
